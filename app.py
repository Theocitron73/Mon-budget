...
def charger_categories_perso():
    defaut = [
        ...
        "💸 Virements envoyé", "🏧 Retraits", "🌐 Web/Énergie", "🔄 Virement : Livret A vers CCP", "🔄 Virement : CCP vers Livret A","❓ Autre"
    ]
    try:
...
def sauvegarder_nouvelle_categorie(nouvelle_cat, username):
    try:
        ...
        st.session_state.LISTE_CATEGORIES_COMPLETE = charger_categories_perso()

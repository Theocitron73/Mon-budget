...
# ---------------------------------------------------
        ...
        with col1:
            ...
            # 1. On définit cats et les indices avant le formulaire
            cats = sorted(st.session_state.df['Categorie'].unique().tolist()) if not st.session_state.df.empty else ["Loisirs", "Santé", "Loyer"]
            ...
            with st.form("bulk_add_form_v4"):
                ...
                submit = st.form_submit_button("ENREGISTRER LES PREVISIONS 💾", use_container_width=True, type="primary")
    ...
    # Popover compact avec onglets
            ...
            with col_add:
                ...
                with st.form("form_reel_multi"):
                    ...
                    submit_reel = st.form_submit_button("ENREGISTRER LES OPERATIONS 🚀", use_container_width=True, type="primary")
